                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="progress mt-2" style="height: 20px;">
                                            <div class="progress-bar bg-warning" role="progressbar"
                                                ...
                                                aria-valuenow="${attemptPercentage}" aria-valuemin="0"
                                                aria-valuemax="100">
                                                ${attemptPercentage}%
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="progress mt-2" style="height: 20px;">
                                            <div class="progress-bar bg-success" role="progressbar"
                                                style="width: ${attemptAccuracy}%;" aria-valuenow="${attemptAccuracy}"
                                                aria-valuemin="0" aria-valuemax="100">
                                                ${attemptAccuracy}%
                                            </div>
                                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="card shadow text-center">
                                    <div class="card-body">
                                        ...
                                        <h3 class="display-6 text-primary">${correctAnswers} / ${totalQuestions}</h3>
                                        <div class="progress mt-2" style="height: 20px;">
                                            <div class="progress-bar bg-primary" role="progressbar"
                                                style="width: ${accuracy}%;"
                                                aria-valuenow="${accuracy}" aria-valuemin="0"
                                                aria-valuemax="100">
                                                ${accuracy}%
                                            </div>
                                        </div>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    <c:forEach var="entry" items="${userAnswers}" varStatus="status">
                                        <tr>
