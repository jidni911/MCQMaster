            ...
            <main>
                ...
                <div class="m-5 text-center">
                    ...
                    <form method="GET" action="/search" class="d-flex justify-content-between">
                        ...
                        <div>
                            <input type="text" name="options" class="form-control" placeholder="Search Options">
                        </div>
                        <div>
                            <input type="text" name="user" class="form-control" placeholder="Search User">
                        </div>
                        <div>
                            <input type="text" name="topic" class="form-control" placeholder="Search Topic">
                        </div>
                        <div>
                            <input type="text" name="domain" class="form-control" placeholder="Search Domain">
                        </div>
                        <div>
                            ...
                            <tbody class="table-group-divider">
                                <c:forEach var="mcq" items="${mcqList}">
                                    ...
                                    <tr class="">
                                        ...
                                        <td>${mcq.domain}</td>
                                        <td>
                                            <a class="btn btn-primary" href="/mcq/edit/${mcq.id}">Edit</a>
