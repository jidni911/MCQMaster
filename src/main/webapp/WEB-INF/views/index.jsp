  ...
  <main>
    ...
    <div class="tab-content" id="myTabContent">
      ...
      <div class="tab-pane fade" id="tab2Id" role="tabpanel">
        ...
        <div id="homeMainDiv" class="d-flex flex-column text-white bg-overlay background">
          ...
          <div class="container my-auto text-center">
            ...
            <h2 class=" fw-bold mb-3" *ngIf="isLoggedin">{{getCurrentUser().name}}</h2>
            <p class="lead mb-4">
            ...
            <div class="d-flex flex-column flex-md-row gap-3 justify-content-center">
              <a routerLink="/mcq/create" class="btn btn-primary btn-lg px-4">Add MCQs</a>
          ...
          <div class="container text-center mt-3" [hidden]="isLoggedin()">
            <p>
              New here?
              <a routerLink="/sign-up" class="text-warning" data-bs-toggle="modal" data-bs-target="#addUserModal">Sign
                Up</a>
              or
              <a routerLink="/sign-in" class="text-warning" data-bs-toggle="modal" data-bs-target="#loggingModal">Sign
                In</a>
            </p>
          </div>
      ...
      <div class="tab-pane fade" id="tab3Id" role="tabpanel">
        ...
        <!-- Button Section -->
        <div class="text-center py-4" *ngIf="isLoggedin()">
        ...
        <div class="container-fluid bg-light py-5" *ngIf="!isLoggedin()">
          <div class="text-center">
            ...
            <button class="btn btn-primary btn-lg mt-3" data-bs-toggle="modal" data-bs-target="#loggingModal">Login</button>
          </div>
        </div>
      ...
      <tbody class="table-group-divider">
        <tr class="moye" *ngFor="let user of allUser ">
          ...
          <td>
            ...
            <a (click)="viewUser(user)" class="btn btn-outline-warning" data-bs-toggle="modal" href="#exampleModalToggle2"
              role="button" *ngIf="isAdmin()">Edit</a>
      ...
      <tfoot>
        <tr>
          <td colspan="7" class="text-center">
            <button *ngIf="isAdmin()" type="button" class="btn btn-outline-primary btn-lg" data-bs-toggle="modal"
